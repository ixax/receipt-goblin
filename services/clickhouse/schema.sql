...
-- carry different fields, so raw_payload keeps the full body until real
-- payloads are captured and first-class columns can be added for what's
-- actually observed), no TTL, half-year PARTITION BY convention.
