...
Read and parse Grafana v2beta1 dashboard JSON via `services/grafana/scripts/parse_dashboard.py`.
Read `Skill(grafana-dashboard-parsing)` first - it has the subcommand reference and the per-file `RowsLayout` gotcha table.
