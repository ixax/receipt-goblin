...
| `OLLAMA_REASONING_MODEL`  | required only if `OLLAMA_HOST` is set | See "Local Ollama models" under "LiteLLM" below.                                                                                                                                                                                                                                        |
| `OLLAMA_EMBEDDINGS_MODEL` | required only if `OLLAMA_HOST` is set | See "Local Ollama models" under "LiteLLM" below.                                                                                                                                                                                                                                        |
...
| `OLLAMA_REASONING_MODEL`      | required                             | litellm - real Ollama tag behind the stable `local_reasoning` `model_name`, e.g. `ollama/gemma3:4b`; must be prefixed with `ollama/` and already pulled on the Ollama host, see "Local Ollama models" below                                                                                                                                                                                                          |
| `OLLAMA_EMBEDDINGS_MODEL`     | required                             | litellm - real Ollama tag behind the stable `local_embeddings` `model_name`, e.g. `ollama/embeddinggemma:300m`; must be prefixed with `ollama/` and already pulled on the Ollama host, see "Local Ollama models" below                                                                                                                                                                                               |
