...
This starts the core stack only. `clickhouse-migrate` is not part of it - run it explicitly once schema/dictionaries are needed (e.g. right after a fresh `make init`, and again any time a new migration file is added):
